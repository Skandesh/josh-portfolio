    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <h3 className="font-poppins text-xl font-semibold mb-4">Contact Info</h3>
            <div className="space-y-3">
              ...
              <p className="flex items-center text-background/70">
                ...
                <Link href="mailto:hey@socialsbyjosh.com" className="hover:text-primary transition-colors">
                hey@socialsbyjosh.com
                </Link>
              </p>
              <p className="flex items-center text-background/70">
                <svg
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-background/70 text-sm">
            © {currentYear} Joshua Vaughan. All rights reserved.
          </p>
          {/* <div className="mt-4 md:mt-0">
              <ul className="flex space-x-6 text-sm text-background/70">
              <li>
